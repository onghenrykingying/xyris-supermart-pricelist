...
4. Set up `Categories` tab with four columns: `POS_Dept`, `POS_Cat`, `Display_Category`, `Display_Sub_Category`. Import `data/pos-category-mapping.csv` with **Replace current sheet**.
